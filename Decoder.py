...
class FocalM(nn.Module):
    def __init__(self, dim, proj_drop=0., focal_level=3, focal_window=7, focal_factor=2,
                 use_postln=False):
        super().__init__()
        self.dim = dim
    ...
    def forward(self, x, q):
        ...
        x_out = x_out.sigmoid() * x_initial

        return x_out


class Decoder(nn.Module):
    def __init__(self, dim,  focal_level=3, focal_window=7, focal_factor=2,):
        super().__init__()
        self.dim = dim
        self.focal_level = focal_level
        self.focal_window = focal_window
